...
pub use types::sse;
pub use types::{
    DownloadFileBy, FileRetention, ListBuckets, ListFiles, NewFileInfo, NewLargeFileInfo, NewPartInfo,
};

/// Autogenerated builders for various types.
pub mod builders {
    pub use crate::types::{
        FileRetentionBuilder, ListBucketsBuilder, ListFilesBuilder, NewFileInfoBuilder, NewLargeFileInfoBuilder,
        NewPartInfoBuilder,
    };
}
...
impl Client {
    ...
    pub async fn list_buckets(&self, query: ListBuckets<'_>) -> Result<Vec<models::B2Bucket>, B2Error> {
        ...
        self.run_request_with_reauth(|b2| async move {
            ...
            state.check_capability("listBuckets")?;
