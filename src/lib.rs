...
pub use types::sse;
pub use types::{
    CreateApplicationKey, DownloadFileBy, FileRetention, ListBuckets, ListFiles, NewFileInfo, NewLargeFileInfo,
    NewPartInfo, UpdateBucket,
};

/// Autogenerated builders for various types.
pub mod builders {
    pub use crate::types::{
        CreateApplicationKeyBuilder, FileRetentionBuilder, ListBucketsBuilder, ListFilesBuilder,
        NewFileInfoBuilder, NewLargeFileInfoBuilder, NewPartInfoBuilder, UpdateBucketBuilder,
    };
}
...
impl Client {
    ...
    pub async fn update_bucket(&self, update: &UpdateBucket<'_>) -> Result<models::B2Bucket, B2Error> {
        ...
        struct B2UpdateBucket<'a> {
            ...
            #[serde(skip_serializing_if = "Option::is_none")]
            bucket_info: Option<&'a std::collections::HashMap<Box<str>, Box<str>>>,
